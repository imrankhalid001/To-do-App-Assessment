...
import com.astutesol.notesappmvvm.databinding.FragmentHomeBinding
    ...
    private fun onClick() {
        binding.apply {
            ...
            BtnBuyList.setOnClickListener {
                findNavController().navigate(R.id.action_homeFragment_to_buyListFragment)
            }
            BtnSellList.setOnClickListener {
                findNavController().navigate(R.id.action_homeFragment_to_sellListFragment)
            }
